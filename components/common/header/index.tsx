...
const Header = ({ siteNavBar, promoTitle, promoLinkText, promoLink, mobilePromoLinkText, brandSidebarProps }: AllHeaderProps): JSX.Element => {
  const brandIconUrl =
  ...
  return (
    <div className={styles["header-container"]}>
      ...
      <LangSelector />
      <SiteNavBar siteNavBar={siteNavBar} />
