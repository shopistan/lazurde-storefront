...
interface LazurdeHeroBannerProps {
  backgroundImage: ImageObject | string;
  bannerText: string;
  buttonText: string;
  buttonLink: string;
  products: EnumServiceItems | string;
}

const LazurdeHeroBannerStatic: FC<LazurdeHeroBannerProps> = ({
  backgroundImage = '',
  bannerText,
  buttonText,
  buttonLink = '',
...
export default LazurdeHeroBannerStatic;
